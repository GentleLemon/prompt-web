...
let {data: promptCategories} = await useFetch('http://127.0.0.1:8000/api/v1/prompts/categories')
...
let {data: prompts} = await useFetch('http://127.0.0.1:8000/api/v1/prompts/', {
    ...
    <div class="grid md:grid-cols-4 gap-3 py-10 px-6">
        <div class="md:col-span-1 px-6 py-6 bg-teal-700 rounded-xl">
            <div class="flex space-x-4">
                <input v-model="query" type="search" placeholder="Find a prompt..." class="w-full px-6 py-4 rounded-xl">
