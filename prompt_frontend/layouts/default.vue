        ...
        <footer class="p-6 flex flex-wrap items-center justify-between bg-gray-900">
            ...
            <div class="flex mt-6 md:mt-0 items-center space-x-4">
                <template v-if="userStore.user.isAuthenticated">
                    <NuxtLink to="/myprompts" class="py-4 px-6 bg-teal-900 hover:bg-teal-700 text-white rounded-xl">My prompts</NuxtLink>
                    <NuxtLink to="/createprompt" class="py-4 px-6 bg-teal-600 hover:bg-teal-700 text-white rounded-xl">Create prompt</NuxtLink>
